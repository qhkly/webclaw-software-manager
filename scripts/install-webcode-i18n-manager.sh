...
DEB_PKG="i18n-manager"
REPO="qhkly/webcode-i18n-manager"
...
echo "[INFO] 获取 Webcode I18N Manager 最新版本..."
...
if [ "$download_ok" != "true" ]; then
    echo "[ERROR] Webcode I18N Manager 下载失败（3次重试后）"
    rm -rf "$TMP"; exit 1
fi
...
rm -rf "$TMP"
echo "[INFO] Webcode I18N Manager 安装完成"
