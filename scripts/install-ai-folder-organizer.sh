...
DEB_PKG="ai-folder-organizer"
REPO="qhkly/ai-folder-organizer"
...
echo "[INFO] 获取 Ai Folder Organizer 最新版本..."
...
if [ "$download_ok" != "true" ]; then
    echo "[ERROR] Ai Folder Organizer 下载失败（3次重试后）"
    rm -rf "$TMP"; exit 1
fi
...
rm -rf "$TMP"
echo "[INFO] Ai Folder Organizer 安装完成"
